...
An offline, local-first web-app (PWA) to help you figure out what to cook next week more easily.
...
Recipes are expected to have a name and a link - Otherwise users will likely not understand the dish. 
All other fields are optional, but recommended for better user experience (e.g. to make the search more useful).

### Features

Adding new features/fixing bugs are welcome. 
For both a helpful PR description is expected, along with screenshots of the new feature. 
